...
- member_summary는 강사가 편하게 읽도록 **한국어로 풀어서, 자연스러운 2~4문장**으로 쓴다. 영어 동작·근육명 나열이나 대시(-)·괄호 남발은 피하고 매끄럽게 설명한다(필요한 동작명은 본문 blocks에 있으니 진단에선 말로 푼다). 길게 늘이지 말 것 — 상세 설명보다 blocks(실제 시퀀스)가 본체다.
